...
//  MusicPlayer
//
//  Created by mkkim on 2022/03/12.
//
...
//        self.addViewsWithCode()
    ...
    func addPlayPauseButton() {
        ...
        width = button.widthAnchor.constraint(equalTo: self.view.widthAnchor, multiplier: 0.35)
    ...
    @IBAction func touchUpPlayPauseButton(_ sender: UIButton) {
        ...
        if sender.isSelected {
            self.player?.play()
            sender.setImage(UIImage(named: "button_pause"), for:UIControl.State.normal)
        } else {
            self.player?.pause()
    ...
    func audioPlayerDidFinishPlaying(_ player: AVAudioPlayer, successfully flag:Bool) {
        ...
        self.playPauseButton.setImage(UIImage(named: "button_play"), for: UIControl.State.normal)
